...
function Game(props) {
    ...
    <div className='bk-front'>
        <div className='bk-cover-back' style={{backgroundImage: 'url('+ props.box_art +')'}}></div>
        <div className={('bk-cover '+ props.system_type)} style={{backgroundImage: 'url('+ props.box_art +')'}} >
    ...
    <div className='bk-page'>
        ...
        <div className={(props.page === 2 && props.clicked ? 'bk-content bk-content-current': 'bk-content')}>
            ...
            <label className="custom-control-label" htmlFor="customSwitches">Owned?{props.owned}</label>
            </div>
        ...
        <div className={(props.page === 4 && props.clicked ? 'bk-content bk-content-current': 'bk-content')}>
